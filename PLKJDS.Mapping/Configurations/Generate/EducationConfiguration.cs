...
namespace PLKJDS.Mapping.Configurations
{
    ...
    /// 数据表映射
    /// </summary>
    partial class EducationConfiguration : EntityConfiguration<Education>
    {
        /// <summary>
        /// 数据表映射构造函数
        /// </summary>
        ...
        {
            EducationConfigurationDefault();
            EducationConfigurationAppend();
        }

        /// <summary>
        /// 默认的数据映射
        /// </summary>
        public void EducationConfigurationDefault()
        {
        ...
        /// 数据映射
        /// </summary>
        partial void EducationConfigurationAppend();
    }
}
