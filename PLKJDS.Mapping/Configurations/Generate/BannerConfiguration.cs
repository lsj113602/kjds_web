...
namespace PLKJDS.Mapping.Configurations
{
    ...
    /// 数据表映射
    /// </summary>
    partial class BannerConfiguration : EntityConfiguration<Banner>
    {
        /// <summary>
        /// 数据表映射构造函数
        /// </summary>
        ...
        {
            BannerConfigurationDefault();
            BannerConfigurationAppend();
        }

        /// <summary>
        /// 默认的数据映射
        /// </summary>
        public void BannerConfigurationDefault()
        {
        ...
        /// 数据映射
        /// </summary>
        partial void BannerConfigurationAppend();
    }
}
