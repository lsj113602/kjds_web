...
namespace PLKJDS.Mapping.Configurations
{
    ...
    /// 数据表映射
    /// </summary>
    partial class AccountTypeConfiguration : EntityConfiguration<AccountType>
    {
        /// <summary>
        /// 数据表映射构造函数
        /// </summary>
        ...
        {
            AccountTypeConfigurationDefault();
            AccountTypeConfigurationAppend();
        }

        /// <summary>
        /// 默认的数据映射
        /// </summary>
        public void AccountTypeConfigurationDefault()
        {
        ...
        /// 数据映射
        /// </summary>
        partial void AccountTypeConfigurationAppend();
    }
}
