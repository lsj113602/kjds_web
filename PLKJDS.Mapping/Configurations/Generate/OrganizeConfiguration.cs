...
namespace PLKJDS.Mapping.Configurations
{
    ...
    /// 数据表映射
    /// </summary>
    partial class OrganizeConfiguration : EntityConfiguration<Organize>
    {
        /// <summary>
        /// 数据表映射构造函数
        /// </summary>
        ...
        {
            OrganizeConfigurationDefault();
            OrganizeConfigurationAppend();
        }

        /// <summary>
        /// 默认的数据映射
        /// </summary>
        public void OrganizeConfigurationDefault()
        {
        ...
        /// 数据映射
        /// </summary>
        partial void OrganizeConfigurationAppend();
    }
}
