...
namespace PLKJDS.Mapping.Configurations
{
    ...
    /// 数据表映射
    /// </summary>
    partial class UserDataConfiguration : EntityConfiguration<UserData>
    {
        /// <summary>
        /// 数据表映射构造函数
        /// </summary>
        ...
        {
            UserDataConfigurationDefault();
            UserDataConfigurationAppend();
        }

        /// <summary>
        /// 默认的数据映射
        /// </summary>
        public void UserDataConfigurationDefault()
        {
        ...
        /// 数据映射
        /// </summary>
        partial void UserDataConfigurationAppend();
    }
}
