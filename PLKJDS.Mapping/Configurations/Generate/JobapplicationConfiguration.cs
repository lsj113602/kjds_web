...
namespace PLKJDS.Mapping.Configurations
{
    ...
    /// 数据表映射
    /// </summary>
    partial class JobapplicationConfiguration : EntityConfiguration<Jobapplication>
    {
        /// <summary>
        /// 数据表映射构造函数
        /// </summary>
        ...
        {
            JobapplicationConfigurationDefault();
            JobapplicationConfigurationAppend();
        }

        /// <summary>
        /// 默认的数据映射
        /// </summary>
        public void JobapplicationConfigurationDefault()
        {
        ...
        /// 数据映射
        /// </summary>
        partial void JobapplicationConfigurationAppend();
    }
}
