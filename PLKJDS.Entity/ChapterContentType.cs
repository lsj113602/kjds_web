...
namespace PLKJDS.Entity
{
    ...
    // ChapterContentType
	// by bobomouse
    public partial class ChapterContentType : EntityBaseModel<ChapterContentType> //,ICreationAudited, IDeleteAudited, IModificationAudited
    {
