...
namespace PLKJDS.Entity
{
    ...
    // TeacherGroup
	// by bobomouse
    public partial class TeacherGroup : EntityBaseModel<TeacherGroup> //,ICreationAudited, IDeleteAudited, IModificationAudited
    {
        ...
        /// 团队名称
        ///</summary>
        public string GName { get; set; } // GName (length: 128)
