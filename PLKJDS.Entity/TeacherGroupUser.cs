...
namespace PLKJDS.Entity
{
    ...
    // TeacherGroupUser
	// by bobomouse
    public partial class TeacherGroupUser : EntityBaseModel<TeacherGroupUser> //,ICreationAudited, IDeleteAudited, IModificationAudited
    {
        ...
        /// 团队ID
        ///</summary>
        public string GroupID { get; set; } // GroupID (length: 64)
