...
namespace PLKJDS.Entity
{
    ...
    // TrainExperience
	// by bobomouse
    public partial class TrainExperience : EntityBaseModel<TrainExperience> //,ICreationAudited, IDeleteAudited, IModificationAudited
    {
        ...
        /// 机构名
        ///</summary>
        public string OrgName { get; set; } // OrgName (length: 128)
