namespace PLKJDS.Common
{
    public class OperatorProvider
    {
        ...
        private string LoginUserKey = "PLKJDS_loginuserkey_2016";
        ...
        public void AddCurrent(OperatorModel operatorModel)
        {
            ...
            WebHelper.WriteCookie("PLKJDS_mac", Md5.md5(Net.GetMacByNetworkInterface().ToJson(), 32));
            WebHelper.WriteCookie("PLKJDS_licence", Licence.GetLicence());
        }
