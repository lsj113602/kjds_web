...
namespace PLKJDS.Common
{
    public static class XXTeaHelper
    {
        ...
        public static string Encrypt(string source, string key)
        {
            ...
            var ints = Encrypt(ToUInt32Array(bytData, true), ToUInt32Array(bytKey, false));
            //LogHelper.DefaultLogger.Debug(ints);
            var bytes = ToByteArray(ints, false);
            //LogHelper.DefaultLogger.Debug(bytes);
