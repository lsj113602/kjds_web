...
namespace PLKJDS.Data
{
    ...
    {
        private PLKJDSDbContext dbcontext = new PLKJDSDbContext();
        ...
        public List<TEntity> FindList<TEntity>(string strSql, Pagination pagination) where TEntity : class
        {
            bool isAsc = pagination.sord.ToLower() == "asc" ? true : false;
            string[] _order = pagination.sidx.Split(',');
            MethodCallExpression resultExp = null;
        ...
        public List<TEntity> FindList<TEntity>(Expression<Func<TEntity, bool>> predicate, string strSql, Pagination pagination) where TEntity : class
        {
            bool isAsc = pagination.sord.ToLower() == "asc" ? true : false;
            string[] _order = pagination.sidx.Split(',');
            MethodCallExpression resultExp = null;
        ...
        public List<TEntity> FindList<TEntity>(string strSql, DbParameter[] dbParameter, Pagination pagination) where TEntity : class
        {
            bool isAsc = pagination.sord.ToLower() == "asc" ? true : false;
            string[] _order = pagination.sidx.Split(',');
            MethodCallExpression resultExp = null;
